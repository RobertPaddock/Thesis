...
\usepackage[style=phys,  biblabel=brackets, citestyle = numeric, sorting=none, backend=biber, doi=false, isbn=false,  url = true, maxnames=5]{biblatex}
...
\flushbottom
\include{text/ch-intro}
\include{text/ch-theory}
\include{text/ch-definitions}
\include{text/ch-lowCR}
\include{text/ch-FurtherSims}
%\include{text/ch-2Dsims}
\include{text/ch-experiment}
\include{text/ch-analysis}
\include{text/ch-conclusions}
...
\include{text/appendix-benchmark}
\include{text/appendix-code}
\include{text/appendix-expt}
